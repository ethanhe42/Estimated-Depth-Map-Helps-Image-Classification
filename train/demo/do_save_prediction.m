function do_save_prediction( depth_inpaint, opts,resizefactor,one_img_file)
...
one_save_dir=img_save_dir;
if ~exist(one_save_dir, 'dir')
    mkdir(one_save_dir);
end


one_cache_file=one_img_file;
depth_inpaint_show=imresize(depth_inpaint_show, 32/size(depth_inpaint_show,1));
