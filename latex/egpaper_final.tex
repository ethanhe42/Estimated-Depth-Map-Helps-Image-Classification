...
we propose to put depth map into practice on a image classification task.
...
is an ill posed problem, since there's no real groundtruth depth map. By 
...
which is a two loss neural network. we build RGBD dataset, and investigate the
quality the depth maps more deeply. moreover, we improve 
